...
export const MonthlyCard = () => {
  ...
  const fetchDataSupply = async () => {
    try {
      const response = await axios.get(`${baseApiUrl}/tablePLNMonthly`);
  ...
  const fetchDataCost = async () => {
    try {
      const response = await axios.get(`${baseApiUrl}/tablePLNMonthlyCost`);
  ...
  const fetchDataEmission = async () => {
    try {
      const response = await axios.get(`${baseApiUrl}/tablePLNMonthlyEmisi`);
