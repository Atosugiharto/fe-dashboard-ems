...
const TotalAllEquipments = ({ data = [], dateStart = "", dateEnd = "" }) => {
  ...
  const series = [
    {
      name: "Consumption",
      data: [data?.total_kWh || 0, data?.planKWH || 0],
    },
  ];
  ...
  const downloadExcel = () => {
    ...
    XLSX.writeFile(workbook, `Summary_All_Equipments.xlsx`);
  };
  ...
  const options = {
    ...
    colors: [
      GlobalVariable.dashboardColor.barUngu,
    ...
    <div>
      <div className="flex justify-between items-center mb-1">
        <h3 className="text-white font-bold">
          Total Electrical Equipment Consumption
        </h3>
        <button
...
export default TotalAllEquipments;
