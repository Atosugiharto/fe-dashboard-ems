...
const HourlySupply = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post(`${baseApiUrl}/chartSolarPVHourly`, {
        date: selectedDate,
      });
  ...
  const options = {
    ...
    colors: [GlobalVariable.dashboardColor.gaugeHijau],
  ...
  const downloadExcel = () => {
    ...
    utils.book_append_sheet(wb, ws, "Hourly_Solar_PV");
    writeFile(wb, `Hourly_Solar_PV-${selectedDate}.xlsx`);
  };
